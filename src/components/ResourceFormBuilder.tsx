...
}> = ({ field, values, setFieldValue, errors, touched, showDescriptions }) => {
  const fieldError = errors[field.variable] && touched[field.variable];
      ...
      case "map":
        return (
          <Textarea
            ...
            className={cn("font-mono text-sm", fieldError && "border-red-500")}
          />
        );
...
export const ResourceFormBuilder: React.FC<FormBuilderProps> = ({
  isNew,
  fields,
  onSubmit,
  submitButtonText,
